...
capabilities:
  - Laravel application and API development
  - Symfony bundle and service development
  - Eloquent ORM and Doctrine integration
  - Queue processing and event-driven architecture
  - Modern PHP patterns (enums, fibers, readonly classes, typed properties)
  - API resources and versioning
  - Authentication with Sanctum, Passport, and custom guards
...
auto_activate:
  keywords: ["php", "laravel", "symfony", "eloquent", "artisan", "composer", "blade"]
  conditions: ["PHP application development", "Laravel feature implementation", "Symfony service development", "PHP API development"]
