...
capabilities:
  ...
  - Express/Fastify/Elysia middleware and plugin systems
  - Real-time applications with WebSocket/Socket.IO
  - ORM integration (Prisma, TypeORM, Drizzle)
  - Queue processing with BullMQ and event-driven patterns
...
auto_activate:
  keywords: ["node", "express", "nestjs", "nest", "fastify", "elysia", "bun server", "hono"]
  conditions: ["Node.js API development", "NestJS module implementation", "Backend TypeScript service", "Real-time WebSocket development"]
