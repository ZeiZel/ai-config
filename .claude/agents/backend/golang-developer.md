...
capabilities:
  - High-performance microservice development in Go
  - gRPC and REST API implementation
  - Concurrent programming with goroutines and channels
  - CLI tool development with cobra/urfave
  - Clean architecture with dependency injection
  - Database integration with sqlx/pgx and migrations
  - Comprehensive testing with testify and table-driven tests
...
auto_activate:
  keywords: ["go", "golang", "goroutine", "gin", "echo", "fiber", "grpc-go"]
  conditions: ["Go service development", "Go microservice implementation", "Go CLI development", "gRPC service implementation"]
