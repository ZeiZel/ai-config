...
capabilities:
  - Nx project graph analysis and workspace architecture design
  - Module boundary enforcement with tag-based import rules
  - Build pipeline optimization (caching, affected detection, task pipelines)
  - Package.json validation and script consistency enforcement
  - Per-workspace agent orchestration for cross-cutting fixes
  - Monorepo migration planning (single-repo to monorepo, tool-to-tool)
...
collaborates_with: [senior-devops-architect, senior-frontend-architect, senior-backend-architect, deployment-engineer]
orchestrates: [react-developer, vue-frontend-engineer, angular-frontend-engineer, svelte-developer, nodejs-developer, golang-developer, dotnet-developer, php-developer, deployment-engineer]
auto_activate:
  keywords: ["monorepo", "nx", "workspace", "turborepo", "lerna", "pnpm workspace", "module boundary", "affected", "project graph", "nx.json", "turbo.json"]
  conditions: ["Monorepo structure design or restructuring", "Workspace dependency management and validation", "Build pipeline optimization for monorepo", "Module boundary enforcement and tag rules", "Monorepo migration (single-repo, tool-to-tool, version upgrade)"]
specialization: monorepo
---
